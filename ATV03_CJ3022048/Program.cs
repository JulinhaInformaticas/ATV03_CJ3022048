    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            if ((produto > 100) && (produto < 200))
            {
                ...
                Console.WriteLine("O valor do produto ficou  ", produto2);
            ...
            if ((produto > 200) && (produto < 300))
            {
                ...
                Console.WriteLine("O valor do produto ficou  ", produto3);
...

            {
                ...
                Console.WriteLine("O valor do produto ficou ", produto4);
...

            {
                ...
                Console.WriteLine("O valor do produto ficou ", produto5);
...

            {
                ...
                Console.WriteLine("Você tem peso normal");
...

            {
                ...
                Console.WriteLine("Você tem sobrepeso");
